...
// checkbox poisen
let checkboxPoison: HTMLInputElement = document.getElementById('checkbox-poison') as HTMLInputElement;
...
// checkbox joy
let checkboxJoy: HTMLInputElement = document.getElementById('checkbox-joy') as HTMLInputElement;
...
// checkbox time
let checkboxTime: HTMLInputElement = document.getElementById('checkbox-time') as HTMLInputElement;
...
let checkboxInvisibility: HTMLInputElement = document.getElementById('checkbox-invisibility') as HTMLInputElement;
